...
namespace DatabaseConnection.Migrations
{
    ...
    [Migration("20201203154943_unqieconstraint")]
    partial class unqieconstraint
    {
            ...
            modelBuilder.Entity("DatabaseConnection.Models.Customer", b =>
                {
                    ...
                    b.HasIndex("EmailAdress", "UserName")
                        .IsUnique()
                        .HasFilter("[EmailAdress] IS NOT NULL AND [UserName] IS NOT NULL");
